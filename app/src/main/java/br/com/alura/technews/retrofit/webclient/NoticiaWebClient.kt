...
class NoticiaWebClient(
  ...
  fun buscaTodas(
    ...
    executaRequisicao(service.buscaTodasWebCliente(), quandoSucesso, quandoFalha)
  }
  ...
  fun salva(
    ...
    executaRequisicao(service.salvaWebCliente(noticia), quandoSucesso, quandoFalha)
  }
  ...
  fun edita(
    ...
    executaRequisicao(service.editaWebCliente(id, noticia), quandoSucesso, quandoFalha)
  }
  ...
  fun remove(
    ...
    executaRequisicao(service.removeWebCliente(id), quandoSucesso, quandoFalha)
  }
}